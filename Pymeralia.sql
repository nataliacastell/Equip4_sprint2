...
CREATE TABLE `Usuaris` (
  ...
  `PassUsuari` varchar(50) NOT NULL,
...
CREATE TABLE `Tasca_Peressupost` (
  `Id` int PRIMARY KEY AUTO_INCREMENT,
...
ALTER TABLE `Resultat` ADD FOREIGN KEY (`IdProbabilitat`) REFERENCES `Probabilidad` (`Id`);
...
ALTER TABLE `Tasca_Peressupost` ADD FOREIGN KEY (`IdTasca`) REFERENCES `Tasca` (`Id`);
